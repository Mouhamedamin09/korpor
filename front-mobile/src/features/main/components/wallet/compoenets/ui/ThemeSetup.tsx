...
const ThemeSetup: React.FC<Props> = ({ selectedTheme, onSelectTheme }) => {
  ...
  return (
    ...
    >
      ...
      {/* theme cards: use onSelectTheme callback instead of direct navigation */}
      {(Object.keys(themes) as ThemeKey[]).map((key) => {
        ...
        return (
          <ThemeCard
            ...
            accentColor={accent}
            groupSrc={groupSrc}
            selected={selectedTheme === key} // Show selection state
            onSelect={() => onSelectTheme(key)} // Use callback instead of navigation
